...
const Register = () => {
  ...
  const handleDistrict = (e) => {
    ...
    const getUpazilaData = districtData.find(
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="">
                ...
                <div className="form-control">
                  ...
                  <select
                    ...
                    className="p-3 border-b-2 bg-transparent outline-none"
                  >
                ...
                <div className="form-control relative">
                  ...
                  >
                    ...
                    {districtData.map((getDistrict, index) => (
                ...
                <div className="form-control relative">
                  ...
                  <select
                    ...
                    className="p-3 bg-transparent border-b-2 outline-none"
                  >
                    <option className="select-disabled">
                      Select Your Upazila
                    </option>
                    {upazila.map((getUpazila, index) => (
                      <option key={index} value={getUpazila.upazila_id}>
